...
class EVERCOASTPLAYBACK_API EvercoastBasicStreamingDataUploader : public IEvercoastStreamingDataUploader
{
public:
	EvercoastBasicStreamingDataUploader(IVoxelRendererComponent* rendererComponent);
	virtual ~EvercoastBasicStreamingDataUploader() = default;
