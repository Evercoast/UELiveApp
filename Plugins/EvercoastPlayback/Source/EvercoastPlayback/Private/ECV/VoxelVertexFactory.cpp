...
public:
	...
	{		
		FVoxelVertexFactory* VertexFactory = (FVoxelVertexFactory*)InVertexFactory;

		ShaderBindings.Add(Shader->GetUniformBufferParameter<FVoxelVertexFactoryParameters>(), VertexFactory->GetVoxelVertexFactoryUniformBuffer());
...
void FVoxelVertexFactory::SetParameters(const FVoxelVertexFactoryParameters& InUniformParameters)
{
	UniformBuffer = FVoxelVertexFactoryBufferRef::CreateUniformBufferImmediate(InUniformParameters, UniformBuffer_MultiFrame);
}

void FVoxelVertexFactory::SetParameters(const FVector3f& InBoundsMin, const float InBoundsDim)
{
...
IMPLEMENT_VERTEX_FACTORY_TYPE(FVoxelVertexFactory, "/EvercoastShaders/EvercoastVoxelVertexFactory.ush", 
...
#else
IMPLEMENT_VERTEX_FACTORY_PARAMETER_TYPE(FVoxelVertexFactory, SF_Vertex, FVoxelVertexFactoryShaderParameters);
IMPLEMENT_VERTEX_FACTORY_TYPE_EX(FVoxelVertexFactory, "/EvercoastShaders/EvercoastVoxelVertexFactory.ush", true, false, true, true, true, false, false);
