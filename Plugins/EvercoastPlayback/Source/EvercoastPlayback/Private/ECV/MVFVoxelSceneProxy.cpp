...
FMVFVoxelSceneProxy::FMVFVoxelSceneProxy(UEvercoastMVFVoxelRendererComp* Component, std::shared_ptr<EvercoastLocalVoxelFrame> InVoxelFrame)
...
FMVFVoxelSceneProxy::~FMVFVoxelSceneProxy()
{
...
void FMVFVoxelSceneProxy::CreateRenderThreadResources(FRHICommandListBase& RHICmdList)
#else
void FMVFVoxelSceneProxy::CreateRenderThreadResources()
#endif
{
	...
	FMVFVoxelVertexFactoryParameters UniformParameters;
...
SIZE_T FMVFVoxelSceneProxy::GetTypeHash() const
{
	static size_t UniquePointer;
	return reinterpret_cast<size_t>(&UniquePointer);
}

void FMVFVoxelSceneProxy::GetDynamicMeshElements(const TArray<const FSceneView*>& Views, const FSceneViewFamily& ViewFamily, uint32 VisibilityMap, FMeshElementCollector& Collector) const
{
...
void FMVFVoxelSceneProxy::SetVoxelData_RenderThread(FRHICommandListBase& RHICmdList, std::shared_ptr<EvercoastLocalVoxelFrame> data)
{
...
FPrimitiveViewRelevance FMVFVoxelSceneProxy::GetViewRelevance(const FSceneView* View) const
{
...
FBoxSphereBounds FMVFVoxelSceneProxy::GetDefaultVoxelDataBounds()
{
