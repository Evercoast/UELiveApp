...
#include "EvercoastRealtimeStreamingVoxelDecoder.h"
#include "EvercoastRealtimeStreamingCortoDecoder.h"
...
static FString DefaultCertificatePath = TEXT("EvercoastRealtime/Content/Crypto/realtime.rootca.crt");
...
static FString CreateTempCertFile(const FString& certPath)
{
	...
	if (fileManager.MakeDirectory(*tempDir, true))
	{
		...
		fileManager.Copy(*tempFilename, *realtimeCryptoFilename);
